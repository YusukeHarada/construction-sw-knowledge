...
| `mid-term-platform-roadmap.md` | 開発基盤・ソフトウェアプラットフォーム中期ロードマップ（ツール・CI/CD基盤・AUTOSAR CP・OS/ミドルウェア＋AP・プロセス標準の4テーマ、LANDCROS 2028との関連整理、2027〜2030年度） | 開発部門・管理職・経営層 |
...
| `j1939-functional-safety.md` | J1939機能安全通信・アタッチメント対応（E2E保護・タイムアウト設計・J1939-75・アタッチメント別対応） | 技術担当者・安全担当 |
